            ...
            if($account['Editable']==='0'){
                ...
                switch ($account['Filtro']) {
                    ...
                    case '0':
                        ...
                        $sql="SELECT ROUND(CAST(DMBTR AS FLOAT64), 2) AS Importe, '".$account['Anualidad']."' AS Anualidad, '".$account['Modulo']."' AS Modulo, '".$account['Cuenta']."' AS Cuenta, ".$account['Id']." AS Id, '".$account['Mes']."' AS Mes, '".$account['Super_Concepto']."' AS Super_Concepto, '".$account['Concepto']."' AS Concepto, '".$account['Pagado']."' AS Pagado, '".$account['Editable']."' AS Editable ".
