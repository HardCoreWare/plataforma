...
class PdoCrud{
    ...
    */
    ...
    /********************************************************************************/
    /*
    select single line from a table
    */
    public function selectRow($table,$cols,$targets,$order){
    ...
    */
    ...
    //
    public function selectCount($table,$col,$targets){
         
        $sql="SELECT COUNT(".$col.") AS ".$col." FROM ".$table." WHERE ".$targets;
